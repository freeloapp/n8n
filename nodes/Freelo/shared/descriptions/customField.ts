...
export const customFieldSelectDescription: INodeProperties = {
	...
	required: true,
	default: '',
	description: 'Select a custom field or enter a custom UUID. Choose from the list, or specify a UUID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. Choose from the list, or specify an UUID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
	typeOptions: {
...
export const customFieldValueSelectDescription: INodeProperties = {
	...
	required: true,
	default: '',
	description: 'Select a custom field or enter a UUID of custom field value. Choose from the list, or specify a UUID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. Choose from the list, or specify an UUID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
	typeOptions: {
